...
function setup() {
  ...
  setUpEngagementGallery();
}

function smoothScroll(event) {
  event.preventDefault();
  var selectedPage = $(this).attr('href').replace(/^.*?(#|$)/,'');
  var destination = pageLocations[selectedPage];
  $('html, body').animate({scrollTop: destination}, 750, function() {
...
function setUpEngagementGallery() {
  ...
  var slider = new $JssorSlider$('engagement_gallery_container', options);
  function scaleEngagementSlider() {
